...
/// </summary>
internal sealed class AcademicPeriodDeactivatedDomainEventHandler : IDomainEventHandler<AcademicPeriodDeactivatedDomainEvent>
{
    public ValueTask Handle(AcademicPeriodDeactivatedDomainEvent domainEvent,
